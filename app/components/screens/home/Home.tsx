  ...
  return (
    <div className={styles.home}>
      <div className={styles.home__container}>
        <header className={scroll ? styles.home__header__scroll : styles.home__header}>
          <div className={styles.home__header__content}>
            <Link className={styles.home__header__content__link} href="/">ra1tsuya</Link>
            <nav className={styles.home__navigation}>
              <ul className={styles.home__navigation__list}>
                <li className={styles.home__navigation__list__item}>
                  <button onClick={() => buttonHandler(ref1)} className={styles.home__navigation__list__item__link}>Home</button>
                </li>
                <li className={styles.home__navigation__list__item}>
                  <button onClick={() => buttonHandler(ref1)} className={styles.home__navigation__list__item__link}>About</button>
                </li>
                <li className={styles.home__navigation__list__item}>
                  <button onClick={() => buttonHandler(ref1)} className={styles.home__navigation__list__item__link}>Skills</button>
                </li>
                <li className={styles.home__navigation__list__item}>
                  <button onClick={() => buttonHandler(ref1)} className={styles.home__navigation__list__item__link}>Portfolio</button>
                </li>
                <li className={styles.home__navigation__list__item}>
                  <button onClick={() => buttonHandler(ref1)} className={styles.home__navigation__list__item__link}>Contacts</button>
                </li>
              </ul>
            </nav>
        ...
        <section className={styles.home__me}>
          <h3 className={styles.home__me__title}>Dmitry Moiseenko</h3>
          <p className={styles.home__me__profession}>
            Frontend developer
          </p>
          ...
          <button className={styles.home__me__connect}>
            Connect with me
          </button>
        </section>
        {/* "flex  flex-col text-fz min-h-100vh w-full " */}
        <section className={styles.home__about} ref={ref2} >
          <p className={styles.home__about__question}>
            Who am I?
          </p>
          <h3 className={styles.home__about__title} >
            About me
          </h3>
          <div className={styles.home__about__content}>
            <Image alt="image" src={aboutimg} />
            <div className={styles.home__about__content__desc}>
              <p className={styles.home__about__content__desc__text}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the </p>
              <div className={styles.home__about__content__desc__name}>
                <div className={styles.home__about__content__desc__name__left}>
                  <User />
                  <p>Name</p>
                </div>
                <p>raitsuya</p>
              ...
              <div className={styles.home__about__content__desc__links}>
                <h3>Links</h3>
                <div className={styles.home__about__content__desc__links__items}>
                  <Link href='/'><Git /></Link>
                  <Link href='/'><Git /></Link>
                  <Link href='/'><Git /></Link>
                  <Link href='/'><Git /></Link>
        ...
        <section className={styles.home__skills}>
          ...
          {currentButton == 0 ? <div className="mt-54">
            ...
            <div className={styles.home__experience}>
              <div className={styles.home__experience__items}>
                ...
                <p className={styles.home__experience__items__text}>Cheto bydet</p>
              </div>
              <div className={styles.home__experience__items}>
        ...
        <section className={styles.home__works}>
          ...
          <Link href='/projects' className={styles.home__works__button}>Show more</Link>
        </section>
      </div>
    </div >
